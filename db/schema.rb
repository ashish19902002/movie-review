...
ActiveRecord::Schema.define(version: 2020_10_28_063636) do
  ...
  create_table "shoot_locations", force: :cascade do |t|
    ...
    t.integer "movie_cast_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["location_id"], name: "index_shoot_locations_on_location_id"
    t.index ["movie_cast_id"], name: "index_shoot_locations_on_movie_cast_id"
  end
